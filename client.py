...
#server_ip = 'localhost'
server_ip = '217.28.221.126'# IP адрес сервера
my_name = 'FAntOM' # никнейм в игре
port = 10000 # Порт
COLOR_SCRIN = ('blue4')
WIDTH_WINDOW, HEIGHT_WINDOW = 1500, 800 # Размеры окна игры
# Список цветов для мобов и еды в RGB
colours = {'0': (255, 255, 0), '1': (255, 0, 0), '2': (0, 255, 0), '3': (0, 255, 255), '4': (128, 0, 128), '5':(255,255,255), '6':(254,91,172), '7':(150,75,0), '8':(75, 0 , 255)}
GRID_COLOUR = (150, 150, 150) # Цвет сетки в RGB
...
pygame.display.set_caption(' Агарио: Голодные игры')
